...
@interface TJTableNetWorkFailView ()
...
@implementation TJTableNetWorkFailView
...
- (void)setUpUI {
    ...
    self.loadImg .image= [UIImage imageNamed:@"trWifi"];
